...
import 'package:geolocator_maps/controllers/point_controller.dart';
import 'package:geolocator_maps/models/location_points.dart';
      ...
      body: FlutterMap(
        ...
        children: [
          ...
          TileLayer(
            ...
            userAgentPackageName: "com.example.geoloacator_maps",
          ),
          //Camda de Marcações
          MarkerLayer(
